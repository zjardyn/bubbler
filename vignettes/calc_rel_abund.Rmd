...
If you want the best of both worlds, you can create a scaled bargraph, and superimpose the proportional abundances.  
...
yes <- dplyr::filter(q, reported_antibiotic_usage == "Yes")
no <- dplyr::filter(q, reported_antibiotic_usage == "No")

p1 <- bar_plot(yes, position = "fill" ,true_line = TRUE)
p2 <- bar_plot(no, position = "fill" ,true_line = TRUE)

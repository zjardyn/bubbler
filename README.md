...
ecology studies, but current implementations are hard to customize,
which has prompted me to develop bubbler. This package works alongside
[phyloseq](https://github.com/joey711/phyloseq) and has been designed to
work with data generated by [dada2](https://github.com/benjjneb/dada2).
Future versions are planned to work with
[qiime2](https://github.com/qiime2/qiime2) output.
...
taxa by (d). We then plot it with ggplot2. To display 6 taxa, a
threshold of 0.06% is set.
...
<img src="man/figures/README-bubble-1.png" width="100%" />
